...
namespace WpfApp1
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public double Starter(double a, double b, double c, double d, double e)
        {
            double k, q, y;
        ...
        public int Fun5_subsidiary(double a, double b, double c, double d, double e)//四次方程实根
        {
            int i = 0;
            double y, p, q, delta;
